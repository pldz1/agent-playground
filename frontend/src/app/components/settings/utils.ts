...
export const MODEL_CAPABILITY_REQUIREMENTS: Partial<
...
export const capabilityKeys: CapabilityKey[] = CAPABILITY_METADATA.map(
  (option) => option.key
);
...
export const createFormStateFromModel = (
  model: ModelConfig
): ModelFormState => {
